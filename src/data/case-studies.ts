...
export const caseStudies: CaseStudy[] = [
  {
    ...
    missingFacts: ["CRA account 是否已开通", "现金流结余", "现有保险和雇主福利", "短中长期目标"],
  ...
  },
  {
    ...
    missingFacts: ["FHSA eligibility", "各账户 room", "信用报告", "月度现金流和债务付款"],
    tasks: ["列出买房前资料清单", "区分账户规则和房贷规则", "写出要问顾问的问题"],
    thinkingPath: ["先查 CRA room", "再看现金流和债务", "最后理解压力测试和保险风险"],
    relatedArticles: [
  ...
  },
  {
    ...
    missingFacts: ["福利 booklet", "现有保单", "紧急备用金", "收入中断时现金流缺口"],
  ...
  },
  {
    ...
    knownFacts: ["边际税率较高", "有 TFSA 和 RRSP room", "有非注册投资", "未来可能买房或创业"],
  ...
  },
  {
    ...
    knownFacts: ["有 RRSP 和 TFSA", "可能有 employer pension", "有房产", "有遗嘱但多年未更新"],
    missingFacts: ["CPP Statement", "OAS 居住年限", "RRSP/RRIF 余额", "受益人指定", "税后支出目标"],
  ...
  },
  {
    ...
    knownFacts: ["公司有收入", "owner 从公司取钱", "有商业贷款或担保", "没有清晰 succession plan"],
    missingFacts: ["T2 和财务报表", "GST/HST 和 payroll 状态", "shareholder agreement", "商业保险", "个人现金流"],
    tasks: ["区分个人和公司资料", "列出税务和法律确认点", "识别 owner 风险"],
