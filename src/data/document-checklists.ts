...
export const documentChecklists: DocumentChecklist[] = [
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "investment-statements", label: "TFSA / RRSP / FHSA / 非注册账户结单" },
  ...
  },
  {
    ...
    title: "注册账户比较清单",
    description: "用于比较 TFSA、RRSP、FHSA 和其他账户前，先整理可用额度、税务记录、资金时间和已有账户资料。",
    advisorQuestions: [
      "我的 CRA 可用额度和金融机构记录是否一致？",
      "这笔钱的使用时间会怎样影响账户选择？",
    ...
    groups: [
      {
        ...
        title: "税务与额度记录",
        items: [
          { id: "cra-account", label: "CRA 账户可查看可用额度的准备信息" },
          { id: "latest-noa", label: "最近 Notice of Assessment / Notice of Reassessment" },
          { id: "tfsa-room", label: "TFSA 可用额度记录和当年交易记录" },
          { id: "rrsp-limit", label: "RRSP 扣除额度和未使用额度" },
          { id: "fhsa-eligibility", label: "FHSA 开户资格、开户年份和供款记录（如适用）" }
        ]
      },
      {
        ...
        title: "已有账户资料",
        items: [
          { id: "tfsa-statements", label: "TFSA 账户结单" },
          { id: "rrsp-statements", label: "RRSP 账户结单" },
          { id: "fhsa-statements", label: "FHSA 账户结单（如已有）" },
          { id: "nonregistered-statements", label: "非注册投资账户结单（如适用）" },
  ...
  },
  {
    ...
    advisorQuestions: [
      "我今年还缺哪些税单、收据或 CRA 记录？",
      "哪些扣除、抵免或自雇费用需要税务专业人士确认？",
      "报税完成后，我应该保存哪些资料给未来贷款、账户额度或规划使用？"
    ],
    groups: [
      {
        id: "identity-cra",
        ...
        items: [
          ...
          { id: "cra-account", label: "CRA 账户可登入和查看邮件/税务资料的准备信息" },
      ...
      },
      {
        ...
        items: [
          ...
          { id: "rrsp-fhsa", label: "RRSP 供款收据、T4FHSA、FHSA 账户结单" },
          { id: "self-employed-income", label: "自雇或副业收入记录、发票和平台报表（如适用）" }
        ]
      },
      {
        ...
        title: "扣除、抵免与收据",
        items: [
          { id: "tuition", label: "T2202 学费单和学生贷款利息记录（如适用）" },
          { id: "childcare-medical", label: "托儿、医疗、捐款、专业会费等收据（如适用）" },
          { id: "rent-property", label: "房租、property tax 或搬家相关资料（如适用）" },
          { id: "business-expenses", label: "自雇费用、GST/HST、车辆或居家办公记录（如适用）" }
        ]
      }
    ]
  },
    ...
    groups: [
      {
        ...
        items: [
          ...
          { id: "bank-statements", label: "最近 3 个月支票账户或储蓄账户结单" },
          { id: "fixed-expenses", label: "房租/房贷、保险、交通、托儿、订阅等固定支出清单" },
          { id: "irregular-expenses", label: "年度或不定期大额支出：房产税、学费、保险年费等" }
        ]
      },
      {
        id: "debts-credit",
        title: "债务与信用",
        items: [
          { id: "credit-card-statements", label: "所有信用卡结单：余额、额度、最低还款额、利率" },
          { id: "loc-loans", label: "信用额度、车贷、学生贷款或个人贷款结单" },
          { id: "payout-terms", label: "每笔债务利率、到期日、是否有抵押、提前还款条件" },
          { id: "credit-report", label: "Equifax 或 TransUnion 信用报告（如已有）" }
        ]
      },
      {
        id: "savings-goals",
        ...
        items: [
          ...
          { id: "account-statements", label: "TFSA / RRSP / FHSA / 非注册账户结单（如已有）" },
          { id: "questions", label: "不确定的问题清单：还债、储蓄、账户额度或预算工具" }
        ]
      }
    ]
  },
    ...
    groups: [
      {
        ...
        items: [
          ...
          { id: "cra-account", label: "CRA 账户注册准备信息" }
        ]
      },
      {
        id: "bank-credit",
      ...
      },
      {
        ...
        items: [
          ...
          { id: "benefit-booklet", label: "雇主福利手册（如已有）" },
  ...
  },
  {
    ...
    groups: [
      ...
      },
      {
        ...
        title: "教育储蓄",
        items: [
          { id: "resp-statements", label: "现有 RESP 账户结单" },
          { id: "subscriber-records", label: "供款人和受益人记录" },
          { id: "grant-history", label: "CESG 或其他政府补助记录" },
      ...
      },
      {
        ...
        items: [
          ...
          { id: "employer-benefits", label: "雇主福利手册" },
  ...
  },
  {
    ...
    title: "房贷续约/转贷清单",
    description: "用于续约、转到其他机构或重新贷款比较前的资料准备。",
    advisorQuestions: [
      "续约、转到其他机构和重新贷款的成本与现金流差别是什么？",
      "当前合同是否有罚金、提前还款权利或限制？",
    ...
    groups: [
      {
        ...
        title: "现有房贷",
        items: [
          { id: "mortgage-statement", label: "最新房贷结单" },
          { id: "renewal-notice", label: "续约通知" },
          { id: "payout-statement", label: "还清金额说明或罚金估算" },
      ...
      },
      {
        ...
        title: "房产成本",
        items: [
          { id: "property-tax", label: "房产税通知" },
          { id: "strata-fee", label: "物业管理费或 condo fee 信息（如适用）" },
  ...
  },
  {
    ...
    groups: [
      ...
      },
      {
        ...
        title: "已有保障资料",
        items: [
          { id: "life-policy", label: "现有人寿保险保单摘要" },
          { id: "ci-disability-policy", label: "重疾、伤残或意外保险资料（如有）" },
          { id: "employer-benefits", label: "雇主福利手册和保障摘要" },
      ...
      },
      {
        ...
        title: "债务与受益人安排",
        items: [
          { id: "mortgage-statement", label: "房贷结单或贷款余额" },
          { id: "debt-list", label: "车贷、学生贷款、信用额度和信用卡余额" },
          { id: "beneficiary-records", label: "保单和账户受益人记录" },
    ...
    groups: [
      {
        ...
        title: "退休收入来源",
        items: [
          { id: "cpp-statement", label: "CPP 供款记录" },
          { id: "oas-residency", label: "OAS 居住年限相关记录" },
          { id: "pension-statement", label: "雇主养老金结单" },
      ...
      },
      {
        ...
        title: "账户与税务",
        items: [
          { id: "rrsp-rrif", label: "RRSP / RRIF 账户结单" },
          { id: "tfsa", label: "TFSA 账户结单" },
          { id: "nonregistered", label: "非注册投资账户结单" },
  ...
  },
  {
    ...
    title: "高收入账户与税务顺序清单",
    description: "用于收入提高后比较 RRSP、TFSA、非注册账户和税务顺序前，整理收入、可用额度、投资和流动性资料。",
    advisorQuestions: [
      "现在税率和未来税率可能有什么差异？",
    ...
    groups: [
      {
        ...
        items: [
          ...
          { id: "income-change", label: "未来 1-3 年收入变化、奖金或 RSU/股票期权记录（如适用）" },
          { id: "rrsp-limit", label: "RRSP 扣除额度和可结转扣除记录" }
        ]
      },
      {
        ...
        title: "账户与投资资料",
        items: [
          { id: "tfsa-statements", label: "TFSA 账户结单和当年供款/提款记录" },
          { id: "rrsp-statements", label: "RRSP 账户结单和供款记录" },
          { id: "nonregistered-statements", label: "非注册投资账户结单" },
          { id: "acb-gains", label: "成本记录、已实现收益/亏损和 T3/T5 资料（如适用）" },
          { id: "fees-summary", label: "投资费用、MER、顾问费用或交易费用摘要" }
        ]
      },
      {
        id: "liquidity-goals",
        ...
        items: [
          ...
          { id: "debt-summary", label: "贷款、信用额度、信用卡和其他负债" },
    ...
    groups: [
      {
        ...
        title: "公司财务",
        items: [
          { id: "t2", label: "T2 公司税申报" },
          { id: "financial-statements", label: "近 2 年财务报表" },
          { id: "business-bank", label: "公司银行账户结单" },
      ...
      },
      {
        ...
        items: [
          ...
          { id: "payroll", label: "薪资记录 / T4 / T5 记录" },
          { id: "shareholder-loan", label: "股东借款记录" },
          { id: "owner-compensation", label: "工资和分红历史记录" }
        ]
      },
      {
        id: "risk-succession",
