...
const enOverrides: Record<string, string> = {
  ...
  "详细资料来源说明": "Detailed document source guide",
  "下面保留原有资料地图，方便你继续查每类文件通常从哪里取得。": "The original document source map is kept below so you can check where each file usually comes from.",
